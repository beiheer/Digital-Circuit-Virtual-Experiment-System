...
KSRam2114::KSRam2114(const QPainterPath& path /*= QPainterPath() */,
	const QList<QPoint>& pinPosList /*= QList<QPoint>() */,
	const QList<ITips>& tipsList /* = QList<ITips>()*/)
	: KSRam(16, 4, 10, 16, "SRAM2114", "静态存储器芯片2114 1K*4位", path, pinPosList, tipsList)
{
	m_nRowNum = 6;
	m_nColumnNum = 4;
	//calculate();
...
KSRam6116::KSRam6116(const QPainterPath& path /*= QPainterPath() */,
	const QList<QPoint>& pinPosList /*= QList<QPoint>() */,
	const QList<ITips>& tipsList /* = QList<ITips>()*/)
	: KSRam(22, 8, 11, 22, "SRAM6116", "静态存储器芯片6116 2K*8位", path, pinPosList, tipsList)
{
	m_nRowNum = 7;
	m_nColumnNum = 4;
	//calculate();
...
KSRam6264::KSRam6264(const QPainterPath& path /*= QPainterPath() */,
	const QList<QPoint>& pinPosList /*= QList<QPoint>() */,
	const QList<ITips>& tipsList /* = QList<ITips>()*/)
	: KSRam(25, 8, 13, 25, "SRAM6264", "HM6264B Series 8K*8位", path, pinPosList, tipsList)
{
	m_nRowNum = 9;
	m_nColumnNum = 4;
	//calculate();
...
KSRam62256::KSRam62256(const QPainterPath& path /*= QPainterPath() */,
	const QList<QPoint>& pinPosList /*= QList<QPoint>() */,
	const QList<ITips>& tipsList /* = QList<ITips>()*/)
	: KSRam(27, 8, 15, 27, "SRAM62256", "静态存储器芯片62256 32K*8位", path, pinPosList, tipsList)
{
	m_nRowNum = 9;
	m_nColumnNum = 6;
	//calculate();
...
KSRam62128::KSRam62128(const QPainterPath& path /*= QPainterPath() */,
	const QList<QPoint>& pinPosList /*= QList<QPoint>() */,
	const QList<ITips>& tipsList /* = QList<ITips>()*/)
	: KSRam(26, 8, 14, 26, "SRAM62128", "静态存储器芯片62128 16K*8位", path, pinPosList, tipsList)
{
	m_nRowNum = 9;
	m_nColumnNum = 5;
	//calculate();
...
KSRam628128::KSRam628128(const QPainterPath& path /*= QPainterPath() */,
	const QList<QPoint>& pinPosList /*= QList<QPoint>() */,
	const QList<ITips>& tipsList /* = QList<ITips>()*/)
	: KSRam(29, 8, 17, 29, "SRAM628128", "HM628128A Series 128K*8位", path, pinPosList, tipsList)
{
	m_nRowNum = 9;
	m_nColumnNum = 8;
	//calculate();
